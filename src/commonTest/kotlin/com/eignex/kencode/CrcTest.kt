...
class CrcTest {
    ...
    @Test
    fun `crc8 smbus check value 123456789`() = assertContentEquals(hex("F4"), Crc8.digest("123456789"))

    @Test
    fun `crc8 smbus empty input`() = assertContentEquals(hex("00"), Crc8.digest(""))
    ...
    @Test
    fun `crc16 x25 check value 123456789`() = assertContentEquals(hex("906E"), Crc16.digest("123456789"))

    @Test
    fun `crc16 x25 empty input`() = assertContentEquals(hex("0000"), Crc16.digest(""))
    ...
    @Test
    fun `crc32 iso-hdlc check value 123456789`() = assertContentEquals(hex("CBF43926"), Crc32.digest("123456789"))

    @Test
    fun `crc32 iso-hdlc empty input`() = assertContentEquals(hex("00000000"), Crc32.digest(""))
